...
game::Oxo myGame = myNode.get_game();

Node<game::Oxo>::Move myMove = myGame.random_action();
...
std::vector< Node<game::Oxo>::NodePointerType > children_ptrs = myNode.get_children();
Node<game::Oxo>* parent_ptr = children_ptrs[0]->get_parent();
std::vector< Node<game::Oxo>::Move > left_moves = children_ptrs[0]->get_moves();
